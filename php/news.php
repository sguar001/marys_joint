...
$subject = 'New message from newsletter form';
...
$okMessage = 'Signed up successfully. We will contact you soon!';
...
try
{
    ...
    $emailText = "You have a new message from your website newsletter form\n";
